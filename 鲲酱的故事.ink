...
-
今天，是你高数考试的日子。你刚刚花了一整夜的时间看完了宋浩的视频。虽然昨天是你第一次接触高等数学，但你想必已经是这个领域的高手了。
你坐在考场上，看着试卷降落到你的座位上。
提笔。
在姓名那一栏中写下了“鲲”。
...
你看到了你命中注定的。
卡车。
看起来是来学校施工的。你知道你不能再等下去了，在同学和监考老师的惊愕之中，你冲向了徐徐启动的卡车。你眼中的世界渐渐失去颜色。人们一定会认为你受到高数的欺压，而去寻死的。那么想必今年高数的及格率一定会很高吧。
+ 一段漫长的黑暗。
->firstDayInNewLand
